...
char pass[] = "Mercy2006";   // your network password
int keyIndex = 0;            // your network key Index number (needed only for WEP)
WiFiClient  client;

unsigned long myChannelNumber =   2750629;
const int ChannelField = 1;
const char * myWriteAPIKey = "8OD5C5RRR0J98VHY";
...
```
# CIRCUIT DIAGRAM:
![ldr sensor](https://github.com/user-attachments/assets/e5da1885-d33a-496a-aead-a6742e8026ca)


# OUTPUT:
![Screenshot (168)](https://github.com/user-attachments/assets/2a38407e-7ede-49b7-b0b9-0b8a33cb50ae)
